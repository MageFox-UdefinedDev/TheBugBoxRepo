...
namespace BugBox.Services
{
    internal class DummyService : IServices
    {
        ...
        {
            new Trap(){ TrapId = 0, Name = "Afla", Comment = "Es una cajita ROJA puesta el dia 22/02/2021", Latitude = "132.0", Longitude = "-125.0", Status = 1},
            new Trap(){ TrapId = 1, Name = "Beta", Comment = "Es una cajita AZUL puesta el dia 28/02/2021", Latitude = "132.1", Longitude = "-125.1", Status = 2},
            new Trap(){ TrapId = 2, Name = "Charlie", Comment = "Es una cajita MORADA puesta el dia 7/02/2021", Latitude = "132.2", Longitude = "-125.2", Status = 2},
            new Trap(){ TrapId = 3, Name = "Delta", Comment = "Es una cajita ROSA puesta el dia 31/02/2021", Latitude = "132.3", Longitude = "-125.3", Status = 3},
            new Trap(){ TrapId = 4, Name = "Echo", Comment = "Es una cajita LILA puesta el dia 16/02/2021", Latitude = "132.4", Longitude = "-125.4", Status = 3},
            new Trap(){ TrapId = 5, Name = "Foxtrot", Comment = "Es una cajita VERDE puesta el dia 17/02/2021", Latitude = "132.5", Longitude = "-125.5", Status = 1},
            new Trap(){ TrapId = 6, Name = "Golf", Comment = "Es una cajita NEGRA puesta el dia 11/02/2021", Latitude = "132.6", Longitude = "-125.6", Status = 1},
            new Trap(){ TrapId = 7, Name = "Hotel", Comment = "Es una cajita BLANCA puesta el dia 09/02/2021", Latitude = "132.7", Longitude = "-125.7", Status = 3}
        };
